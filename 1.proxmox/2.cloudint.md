...
This guide documents the exact steps to prepare an **Ubuntu 24.04 (Noble)** cloud-init image for use in **Proxmox VE 9**.  
...
### 4️⃣ Install Proxmox Agent, SSH and update the timezone
```bash
