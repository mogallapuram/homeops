# 🧩 Proxmox VE 9 Installation & Post-Setup (HomeOps Edition)
...
## 6️⃣ Remove Subscription Popup (✅ Working Fix)
...
If you prefer a modern dark theme for the Proxmox web interface, you can use the **Proxmox-Dark Theme** package by Weilbyte.  
This theme adds a clean black/dark-blue interface and automatically re-applies after updates.
nothing from my side it is from https://github.com/Weilbyte/PVEDiscordDark repo
...
- Works perfectly on **Proxmox  9.x**
- Compatible with **Trixie** base
