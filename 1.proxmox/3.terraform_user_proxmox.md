# 🔐 Creating a Terraform Role and Token in Proxmox VE 9
...
⚠️ **IMPORTANT:** Copy and save the token `value` - you cannot retrieve it later!
...
Create a `terraform.tfvars` file (⚠️ add to .gitignore):
...
## 📝 Important Notes for Non-Shared Storage Clusters
